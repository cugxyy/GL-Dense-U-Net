...
if __name__ == '__main__':
    image = cv2.imread('/media/cugxyy/c139cfbf-11c3-4275-9602-b96afc28d10c/DL/Road_Segmentation/test_data/Test_Image2/image152_00.jpg', flags=-1)
    mask = cv2.imread('/media/cugxyy/c139cfbf-11c3-4275-9602-b96afc28d10c/DL/Road_Segmentation/result/image152_00.bmp', flags=-1)//255

    img = draw_mask_on_image_array(image, mask)
    cv2.imwrite('densenet_unet_gau.jpg', img)
